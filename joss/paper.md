...
applications can be found in this work of `[@Vicent1993]`.
...
searched. Fig. \autoref{fig:thr} shows this decomposition process.  It
...
ARs at consecutive time points. Fig. \autoref{fig:track} shows an
